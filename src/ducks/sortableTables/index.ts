...
export const sortableTableSelector = (key:string) => (state:RootState) => state.sortableTables[key] || {key, field: '', ascending: false};
...
const sortableTablesReducer = (state:SortableTablesState = {}, action:SortableTablesAction) => {
